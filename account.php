  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==7) echo'class="active"'; ?>><a href="account.php?q=7"><span class="" aria-hidden="true"></span>&nbsp;linux</a></li>
        <li <?php if(@$_GET['q']==8) echo'class="active"'; ?>><a href="account.php?q=8"><span class="" aria-hidden="true"></span>&nbsp;networking</a></li>
        <li <?php if(@$_GET['q']==9) echo'class="active"'; ?>><a href="account.php?q=9"><span class="" aria-hidden="true"></span>&nbsp;programming</a></li>
...
$q=mysqli_query($con,"SELECT * FROM options WHERE qid='$qid' ORDER BY RAND() LIMIT 4" );
