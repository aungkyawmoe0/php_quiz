  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6">linux</a></li>
        <li <?php if(@$_GET['q']==7) echo'class="active"'; ?>><a href="dash.php?q=7">networking</a></li>
        <li <?php if(@$_GET['q']==8) echo'class="active"'; ?>><a href="dash.php?q=8">programming</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Category</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$tag.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
...
$result = mysqli_query($con,"SELECT * FROM quiz WHERE `tag`='linux' ORDER BY date DESC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Category</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
...
$result = mysqli_query($con,"SELECT * FROM quiz WHERE `tag`='networking' ORDER BY date DESC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Category</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
...
$result = mysqli_query($con,"SELECT * FROM quiz WHERE `tag`='c++' OR `tag`='PHP' ORDER BY date DESC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Category</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update.php?q=addqns&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'&ch=4 " enctype="multipart/form-data" method="POST">
<fieldset>
';
...
<div class="form-group"> 
  <div class="col-md-12">
  <label class="control-label p-2" for="qns'.$i.' ">Image (optional): </label> 
    <input value="" type="file" name="uploadfile'.$i.'" accept="image/png, image/jpeg, image/gif, image/jpg," /> 
  </div>
</div>
<!-- Text input-->
<div class="form-group">
